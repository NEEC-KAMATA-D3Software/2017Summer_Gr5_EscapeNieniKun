...
namespace Action.Scene
{
    class Map
    {
        ...
        private List<GameObject> AddBlock(int lineCnt, string[] line)
        {
            ...
            objectList.Add("1", new Field(Vector2.Zero, gameDevice));
            objectList.Add("2", new Block(Vector2.Zero, gameDevice));
            objectList.Add("3", new Pitfall(Vector2.Zero, gameDevice));
            objectList.Add("4", new Renga(Vector2.Zero, gameDevice));
            objectList.Add("9", new DeathBlock(Vector2.Zero, gameDevice));
            ...
            foreach(var s in line)
            {
                try
                {
                    ...
                    work.SetPositon(new Vector2(colCnt * 32, lineCnt * 32));
                    workList.Add(work);
                }
                catch(Exception e)
                {
